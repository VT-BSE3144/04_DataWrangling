...
R also has another nifty logical operator `%in%`, which searches for a matches of one vector in another and returns true for any matching values. So for example:
