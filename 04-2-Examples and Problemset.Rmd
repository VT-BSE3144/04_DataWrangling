---
title: "Week3 In-class Exercises and Homework"
output:
...
These exercises are from Data Carpentry. Collectively, they apply what you read in [*R for Data Science*](https://r4ds.had.co.nz/transform.html). We will start these in class using live coding and pair programming on Monday. The exercises along with a cheat sheet summary of the main concepts are this week's homework. You'll turn in a pdf generated from this document of your cheat sheet and exercises.
...
Part of this cheat sheet exercise is to give you a little R markdown practice. You can use backticks \` (next to 1 on your keyboard) to enclose text that you want to be formatted like it is within a code chunk, like `function()`.

## Exercise 1 - basic manipulation

Data from an experiment is located in the working directory called exercise1_data.csv. Perform each step below:
...
```{r}
ex1 <- read_csv(file = "exercise1_data.csv")

```

Now, you'll want to activate dplyr and use the `select` command.
